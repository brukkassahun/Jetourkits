...
const installStyle: Record<string, string> = {
  ...
  "Bolt-On": "border-ink/30 bg-ink text-cream",
    ...
    <div className="min-h-screen bg-cream">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10">
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <span className="rounded-full border border-line bg-paper px-3 py-1 font-sans text-[11px] font-bold uppercase tracking-wider text-muted">
                {compatTag(p)}
              </span>
              <span className="rounded-full border border-ink/30 bg-ink px-3 py-1 font-sans text-[11px] font-bold uppercase tracking-wider text-cream">
                {p.style}
              </span>
              <span className="rounded-full border border-line bg-paper px-3 py-1 font-sans text-[11px] font-bold uppercase tracking-wider text-muted">
                {p.kitType}
            ...
            <h1 className="display-lg mt-4 text-3xl text-ink sm:text-4xl">
              {p.brand} {p.model} <span className="text-accent">{p.name}</span>
            </h1>
            ...
            <a
              ...
              className="mt-3 block rounded-full border border-success/40 bg-success/10 px-5 py-3 text-center font-sans text-sm font-bold uppercase tracking-wider text-success transition-colors hover:bg-success/20"
            >
        ...
        <div className="mt-12 grid gap-5 lg:grid-cols-3">
          <section className="card-coda p-6">
            <h2 className="flex items-center gap-2 title">
          ...
          <section className="card-coda p-6">
            ...
            <span className={`mt-4 inline-block rounded-full border px-3 py-1.5 font-sans text-[11px] font-bold uppercase tracking-wider ${installStyle[p.install]}`}>
              {p.install}
            </span>
